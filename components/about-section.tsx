  ...
  return (
    <div className="mb-16 last:mb-0">
      ...
      >
        ...
        <div className="md:w-1/2">
          <div className="relative h-64 md:h-80 w-full rounded-xl overflow-hidden shadow-lg border-2 border-white">
      ...
      {relatedVideos && relatedVideos.length > 0 && (
        <div className="mt-8">
          <h4 className="text-xl font-semibold text-gray-600 mb-4">Videos Relacionados</h4>
